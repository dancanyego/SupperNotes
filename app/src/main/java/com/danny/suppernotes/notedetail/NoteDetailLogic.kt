...
import com.danny.suppernotes.common.BaseLogic
import com.danny.suppernotes.common.MESSAGE_DELETE_SUCCESSFUL
import com.danny.suppernotes.common.MESSAGE_GENERIC_ERROR
...
class NoteDetailLogic(dispatcher: DispatcherProvider,
    ...
    private fun renderView(state: ContactsContract.CommonDataKinds.Note) {
    ...
    private fun prepareRegisteredRepoDelete(note: ContactsContract.CommonDataKinds.Note) = launch {
    ...
    private fun prepareAnonymousRepoDelete(note: ContactsContract.CommonDataKinds.Note) = launch {
